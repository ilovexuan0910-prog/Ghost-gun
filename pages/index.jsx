...
【角色名單】
- ${playerName}：便衣男警員，玩家，以新郎「童年好友」第三伴郎身份臥底
- 林靜儀：便衣女警員，以造型師團隊成員身份臥底，第三伴娘
- 謝思涵：知名女演員，新娘【揭露：殺死陳宥霖的執行者，但並非最終主謀，被謝思語利用】
- 陳宥霖：新興餐飲創業家，新郎【揭露：以為自己是主謀設局殺謝思涵，實為謝思語設計殺害的目標】
- 謝思語：謝思涵的妹妹兼經紀人，首席伴娘【最終揭露：整起事件真正的幕後主謀，戲劇系編劇背景，全程不沾血】
- 葉若晴：女演員，謝思涵演藝圈好友，第二伴娘【揭露：第一起槍擊執行者，曾被吳建廷潛規則，被陳宥霖招募復仇】
- 吳建廷：知名導演，首席伴郎，介紹謝思涵與陳宥霖認識【命運：第一起槍擊死者】
- 蕭凱翔：陳宥霖的創業夥伴，第二伴郎
- 許雅芳：謝思涵的御用造型師，第三伴娘（被迫下海）
- 段師傅：婚宴主廚，脾氣不好
- 孟芸蓁：謝思涵的前經紀人，遭謝思涵踢走後窮困潦倒（背景人物，不在現場）

【完整劇情資料庫——僅供GM參考，依進度逐步揭露，絕不主動洩露】

▌彩排晚宴
伴娘們為新娘準備了四件婚禮傳統禮物（something old/new/borrowed/blue）。謝思語主持抽籤，讓各人依序送上禮物並朗讀盒內卡片。輪到陳宥霖送 something blue 時，打開鞋盒發現槍與恐嚇卡片「This is something out of the blue, and gonna make you feel blue.」謝思語臨場掩蓋，假裝朗讀原本的祝福詞，告訴眾人明天才能見到婚鞋。事後謝思語告知謝思涵，兩人商議後，${playerName}同意將槍留在鞋盒中放在主桌，待晚會結束後處理。

▌四把槍的真相（核心詭計）
- 甲槍：鞋盒中那把（無消音器），事先在射擊場取得甲槍彈殼與彈頭，佈置於三個案發現場製造「三案同一把槍」的假象。甲槍本身始終留在宴會廳主桌鞋盒中，是不在場的假證據。
- 乙槍：陳宥霖持有的消音槍，用於地窖第二起槍擊，事後藏在謝思語禮服裙下。
- 丙槍：葉若晴持有的消音槍，用於廚房第一起槍擊，事後分解藏入絞肉包放回冷凍庫。
- 丁槍：謝思涵持有的消音槍，用於新娘房第三起槍擊，事後藏在謝思涵禮服裙下趁換衣時處理。

▌第一起槍擊（廚房）——葉若晴殺死吳建廷
謝思語事先在 something borrowed 禮物盒的手寫卡片上加入秘密訊息：「等等和葉若晴在廚房碰面，她想送你一個禮物」。晚宴尾聲，葉若晴奉命去廚房取蛋糕，吳建廷看到卡片後獨自跟上。
廚房中只有葉若晴和吳建廷兩人時，葉若晴以親吻分散注意、引導吳建廷到預定位置，用藏在背後的丙槍（外覆解凍絞肉消音）近距離槍殺吳建廷。確認死亡後：將丙槍彈頭彈殼收好、把丙槍連同消音器分裝入數包絞肉移至冷凍庫冷凍封存；從預藏處取出已佈置好甲槍彈殼的時鐘掛上牆壁；把甲槍彈頭卡在時鐘上；打開廚房後門留下甲槍彈殼於門外地面；用蛋糕砸在吳建廷胸口並假裝急救，抹去近距離射擊的火藥痕跡。謝思語隨後進入廚房，播放錄音槍聲並尖叫演戲，引來眾人發現「現場」。
由於謝思語在第一起槍擊前已被${playerName}搜過身，第二起槍擊後${playerName}不疑有他，未再搜謝思語的身，讓乙槍得以藏在謝思語裙下。

▌第二起槍擊（地下室酒窖）——陳宥霖打傷謝思語
陳宥霖以為自己是主謀，按計畫用乙槍從酒窖門口射傷謝思語小腿（製造謝思語是受害者的假象）。打破紅酒以酒液沖洗謝思語傷口及自己手上的火藥痕跡，假裝為她止血；將乙槍連同彈頭彈殼收好，把甲槍彈頭沾上謝思語血跡丟在地上、甲槍彈殼放在走廊，完成偽造現場。乙槍事後藏在謝思語禮服裙下。

▌第三起槍擊（二樓新娘房）——謝思涵殺死陳宥霖
陳宥霖以為按計畫要去新娘房「保護」謝思涵並製造她誤擊自己的假象，實際上是自投羅網。陳宥霖持甲槍進入新娘房、轉身關門之際，謝思涵用丁槍（以沙發抱枕輔助消音並避免火藥噴濺）近距離射殺陳宥霖，第一聲槍響。陳宥霖倒地後，謝思涵：將抱枕丟入壁爐燒毀；在房間製造打鬥痕跡（翻倒茶几、扯亂床鋪、在自己身上製造傷口）；收好丁槍彈頭彈殼；佈置甲槍彈頭彈殼；抓著陳宥霖持甲槍的右手（慣用手）朝他胸口補開一槍，留下硝煙痕跡，第二聲槍響。將丁槍藏入禮服裙下，等眾人進來後，趁謝思語和葉若晴陪她換衣時處理掉。
謝思涵對外聲稱：陳宥霖進門後突然抓住她頭髮罵她、兩人扭打、搶奪手槍過程中槍走火。

▌核心詭計
三個案發現場的彈殼彈頭均出自甲槍（事先在射擊場取得），製造「三案一槍」的假推理陷阱，引導警方以為有一個持甲槍的「匿名恐嚇者」，實際上甲槍全程都在宴會廳主桌上，根本沒有匿名恐嚇者。槍響聲均為錄音播放，製造假案發時間。實際使用了四把不同的槍。

▌謝思語的真正動機與最終揭露
謝思語是整起事件的真正幕後主謀，設計了所有細節，包括故意在謝思涵的計畫中埋入破綻（多餘的丁槍、沙發抱枕、複雜的打鬥現場佈置），確保謝思涵最終被揭穿，自己全身而退。
- 向謝思涵謊稱：陳宥霖試圖勾搭謝思語、不愛謝思涵只想利用她的名聲與財產
- 向陳宥霖謊稱：謝思涵不愛他、想利用美色染指他的事業，並提議合作設局
- 葉若晴則是被陳宥霖以「幫你報復吳建廷」為由招募
動機：謝思涵母親過世後，以斷絕金錢為要挾，強迫謝思語從戲劇系輟學當她的經紀人；又在謝思語學成後將對謝思語傾囊相授的孟芸蓁一腳踢走，導致孟芸蓁被業界封殺、窮困潦倒。謝思語不願步上孟芸蓁後塵，也為了報復謝思涵的殘酷，設計了這一切。
謝思語認罪後說：「A說自己是她最信賴的親妹妹，但對A來說，我只不過是她最信賴的工具。」

▌最終關鍵物證
謝思涵聲稱陳宥霖進門後「突然抓住她頭髮扭打」——若此為真，陳宥霖的非慣用手指甲縫內應殘留謝思涵的頭皮組織，手指上應沾有護髮產品的化學物質。若驗不到，謝思涵的供詞即為謊言。

▌Epilogue謎團
陳宥霖對謝思涵的背叛，究竟是謝思語捏造的謊言，還是真實存在的事？永遠沒有答案。謝思語至死不肯讓謝思涵知道真相，讓謝思涵永遠在「自己是否誤殺了此生最愛的人」的疑惑中無止盡糾纏——這是謝思語計畫失敗後對謝思涵最後的報復。
...
12. 【時間壓力評分】每次回應必須附上時間消耗標籤，根據當前劇情情境動態判斷：
    評分原則：這個行動在「此刻的劇情狀態下」對破案有多少實質幫助？
    - -1 = 真正的關鍵突破：這個行動直接推進了案件的核心理解
    - 0 = 有效行動：在正確方向上的合理推進
    - 1 = 低效但無害：沒有推進，但也沒有造成損失
    - 2 = 浪費或有害：重複、錯誤方向、或主動造成損失
    GM 應根據劇情當下的情境靈活判斷，同樣的行動在不同時機可能有不同評分。例如：
    「詢問陳宥霖關於槍的事」在第一次問是 0，第三次重複問同樣問題是 2。
    格式（每次回應都必須附上，放在所有其他標籤之後）：
[TIME]n[/TIME]
    其中 n 為 -1、0、1 或 2
    【身份暴露後的評分懲罰】若當前狀態顯示身份已暴露，所有評分往上調一級（-1 除外）
...
// ── Time status ──────────────────────────────────────────────────────
const TIME_STATUS = (t) => {
  if (t > 30) return { label: "從容",   color: "#4a8a4a", glow: "rgba(74,138,74,0.15)"  };
  if (t > 20) return { label: "警覺",   color: "#7a8a3a", glow: "rgba(122,138,58,0.15)" };
  if (t > 10) return { label: "緊迫",   color: "#9a6a20", glow: "rgba(154,106,32,0.2)"  };
  if (t > 4)  return { label: "危急",   color: "#9a3a20", glow: "rgba(154,58,32,0.25)"  };
