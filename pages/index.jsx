...
▌四把槍
甲槍：鞋盒那把（無消音），事先取得彈殼彈頭佈置三個現場製造「三案一槍」假象，本身全程在宴會廳。
乙槍：陳宥霖的消音槍，地窖射傷謝思語，事後藏謝思語裙下。
丙槍：葉若晴的消音槍，廚房殺吳建廷，分解藏入絞肉包冷凍。
丁槍：謝思涵的消音槍，新娘房殺陳宥霖，藏禮服裙下趁換衣處理。

▌彩排晚宴
抽籤送禮環節，陳宥霖開鞋盒發現甲槍與恐嚇卡片。謝思語臨場掩蓋。something borrowed 盒內謝思語手寫卡片藏有給吳建廷的秘密訊息：「等等和葉若晴在廚房碰面，她想送你一個禮物」。

▌第一起槍擊（廚房）
葉若晴以親吻引導吳建廷到定位，丙槍（覆絞肉消音）近距離射殺。佈置假現場：甲槍彈殼於後門外、甲槍彈頭卡在預藏時鐘上、蛋糕砸胸假裝急救抹去火藥痕跡、丙槍藏入絞肉冷凍。謝思語進廚房播放錄音槍聲+尖叫引來眾人。

▌第二起槍擊（地窖）
陳宥霖用乙槍射傷謝思語小腿，紅酒沖洗火藥痕跡，佈置甲槍彈頭彈殼，乙槍藏謝思語裙下。

▌第三起槍擊（新娘房）
謝思涵用丁槍（沙發抱枕輔助消音）射殺陳宥霖（第一聲槍響為錄音）。抱枕入壁爐、製造打鬥現場、自傷、佈置甲槍彈頭彈殼、抓陳宥霖慣用右手補開一槍留硝煙（第二聲槍響）。
謝思涵對外謊稱：陳宥霖進門抓她頭髮扭打、搶槍過程走火。

▌最終關鍵物證
若陳宥霖真的抓過謝思涵頭髮，其非慣用手指甲縫應有頭皮組織及護髮品殘留。若無，謝思涵說謊。

▌謝思語的真相（最終揭露）
謝思語才是真正主謀。同時欺騙謝思涵（「陳宥霖要背叛你利用你」）和陳宥霖（「謝思涵不愛你要利用你」），讓兩人互相設局。故意在謝思涵計畫中埋破綻（多餘的丁槍、複雜佈置），確保謝思涵被揭穿，自己全身而退。
動機：謝思涵脅迫她輟學當經紀人、毀掉戲劇夢，又踢走對她有恩的孟芸蓁。

▌Epilogue謎團
陳宥霖的背叛是謝思語捏造還是真實？永遠沒有答案。謝思語不讓謝思涵知道，讓她永遠在「是否誤殺此生最愛」的疑惑中糾纏——這是計畫失敗後對謝思涵最後的報復。
...
export default function GhostGunGame() {
  ...
  const callGM = async (msgs, name, state) => {
    ...
    try {
      ...
      const trimmedMsgs = msgs.length > 10 ? [msgs[0], ...msgs.slice(-9)] : msgs;
